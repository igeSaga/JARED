---
title: "06 - KBOB - Ökobilanz-Kennwerte"
...
wd<-getwd()
htmlwidgets::saveWidget(m, file=paste(wd,"/output/06_output/map/mapPrimaerEnergie.html",sep=""),selfcontained = T)

#buildings speichern
save(rolle_bld_out,file="output/06_output/geom/06_rolle_bld_out.Rdata")
```
