...
In diesem Skript wird eine Abschätzung des Windpotentials für Rolle und Mont-sur-Rolle gemacht. Dabei wird nur die Zone hohen Windpotentials berücksichtigt. Alle Berechungen basieren auf den Angaben von https://wind-data.ch/.
...
#Windpotential Schweiz und Rolle
...
```{r save}
#abbildung speichern
ggsave(p,filename = "output/05_output/viz/windpotential.png",dpi = 500,width = 8,height = 4)
```
